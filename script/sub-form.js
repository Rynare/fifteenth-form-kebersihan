const theTemplate = `
    <div class="relative sub-form">
        <div class="img-wrapper w-[119.63px] aspect-square absolute top-0 left-0">
            <img src="" alt="" class="w-[119.63px] aspect-square">
            <label for="id___input-name__" class="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center rounded-2xl">
                ...
                <button type="button"
                    class="items-center justify-center gap-1 px-2 font-bold text-white rounded-md py-1">
            ...
            <input type="file" name="file___input-name__" hidden id="id___input-name__" required type="file" capture="environment" accept="image/*">
        </div>
        <div class="pb-3 rounded-md task-text flex flex-col justify-between min-h-[166px]">
            <div class="flex gap-1">
                <div class="pre-padding shrink-0"></div>
                <p class="p-3">__task-text__</p>
            </div>
            <p class="py-2 mx-3 text-center rounded-md task-footer mt-auto">
                upload 1 file yang didukung: image dengan ukuran maks 10Mb
            </p>
        </div>
    </div>
`
