    ...
    <div class="sub-form">
                        <div class="relative">
                            <div class="rounded-md task-text flex flex-col justify-between min-h-[166px]">
                                ...
                                <div
                                    class="flex items-center justify-center gap-2 py-2 pb-2 text-white bg-black rounded-br-md mt-[-30px]">
                                    <div
                                        class="img-wrapper w-[120px] aspect-square relative shrink-0 left-[-30px] bottom-[-30px]">
                                        ...
                                        <range-slider name="score___input-name__"
                                        class="w-full mt-[22px] pb-7 ms-[-30px] me-[10px]"></range-slider>
                                </div>
                            </div>
                        </div>
                    </div>
