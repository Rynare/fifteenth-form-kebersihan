const theTemplate = `
    <div class="relative sub-form">
        <div class="img-wrapper w-[119.63px] aspect-square absolute top-0 left-0">
            ...
            <label for="id___input-name__" class="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center">
                ...
                <button type="button"
                    class="items-center justify-center gap-1 px-2 font-bold text-white rounded-md">
